...
void TcpMgr::initHandlers() {
	...
	_handlers.insert(ID_TEXT_CHAT_MSG_RSP, [this](RegId id, int len, QByteArray data) {
		Q_UNUSED(len);
		qDebug() << "handle id is " << id << " data is " << data;
		// 将QByteArray转换为QJsonDocument
		QJsonDocument jsonDoc = QJsonDocument::fromJson(data);
	...
	_handlers.insert(ID_NOTIFY_TEXT_CHAT_MSG_REQ, [this](RegId id, int len, QByteArray data) {
		Q_UNUSED(len);
		qDebug() << "handle id is " << id << " data is " << data;
		// 将QByteArray转换为QJsonDocument
		QJsonDocument jsonDoc = QJsonDocument::fromJson(data);
